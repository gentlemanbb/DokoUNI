...
<script>
    $(document).ready(function(){
        $('#BtnRegist').click(function(){
            ...
            // バリデーションの代わり
            if(argData.userName.length < 3){
                alert("ユーザ名は3文字以上でなければいけません");
                return false;
            }
            ...
            // バリデーションの代わり
            if(argData.emailAddress.length > 0 && !IsMailAddress(argData.emailAddress, "メールアドレス")){
                return false;
            }
            else{
                argData.emailAddress = '';
            }
...
<body>
    <div class="sendWrapper">
        ...
        <div>
            ...
            <p>
                <label for="label_email_address" accesskey="n">E-Mailアドレス（空でもOK）：</label><br/>
                <input type="text"  id="EMailAddress" cols="20" rows="1"></textarea>
            </p>
            <p>
